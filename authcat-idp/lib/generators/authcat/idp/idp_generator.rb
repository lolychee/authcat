...
module Authcat
  class IdpGenerator < ActiveRecord::Generators::Base
    ...
    def inject_marco_content
      inject_into_file "app/models/#{model_singular_name}.rb", "  include Authcat::IdP::Record \n\n",
                       after: /class #{model_name}.*\n/
      inject_into_file "app/models/#{singular_name}.rb", "  has_many_idp_credentials\n",
                       after: /class #{name}.*\n/
    end
