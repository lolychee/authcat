...
module Authcat
  class PasswordGenerator < ActiveRecord::Generators::Base
    ...
    def inject_marco_content
      inject_into_file "app/models/#{model_singular_name}.rb", "  include Authcat::Password::Record \n\n",
                       after: /class #{model_name}.*\n/
      inject_into_file "app/models/#{singular_name}.rb", "  has_many_passwords\n",
                       after: /class #{name}.*\n/
    end
